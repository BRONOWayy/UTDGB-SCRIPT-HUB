...
StatusLabel.Text = "Old cache destroyed. Version 1.0.4 active."
...
---------------------------------------------------------
-- 3. ANIMATION CANCELLER & VALUE RESET PIPELINE
---------------------------------------------------------
RunService.Heartbeat:Connect(function()
    ...
    -- Part A: Handle structural data property changes safely
    if activeTool then
    ...
    -- Part B: Force attack animation track terminations instantly
    ...
    if humanoid and activeTool then
        ...
        for i = 1, #tracks do
            ...
            -- Keep baseline states alive, drop active attack swing tracks instantly
