...
if CoreGui:FindFirstChild("NebulaX_Elite_Final") then 
    CoreGui.NebulaX_Elite_Final:Destroy() 
end
...
XLabel.Position = UDim2.new(0, 0, 0.45, 0)
XLabel.Text = "X"
...
local function CreateTab(name, order)
    ...
    TabBtn.Position = UDim2.new(0.075, 0, 0, 100 + (order-1)*45)
    TabBtn.Text = name
